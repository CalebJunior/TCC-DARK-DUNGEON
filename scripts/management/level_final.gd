...
func _ready() -> void:
	...
	data_management.initial_position = Vector2(22,304)
	data_management.load_data()
	player.global_position =  Vector2(22,304)
	stats.moeda = data_management.data_dictionary.moedas
	stats.moedas_pegas = data_management.data_dictionary.moedas_pegas
	
func on_game_over()->void:
	data_management.initial_position = Vector2(62,304)
...
func passar_fase()->void:
		data_management.save_data()
		OS.delay_msec(300)
		get_tree().change_scene("res://scenes/management/pós-crédito.tscn")
